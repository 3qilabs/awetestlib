...
<title>WAFT: ' + @browser + ' ' + nice_name + '</title>
<style type=text/css>
        table {
  ...
  <tr>
      ...
      <table width=100% border=0 cellpadding=2 cellspacing=2>
        <tbody>
          <tr align="center">
            ...
            <td  class="report_title title" align=right><p class=title>WAFT Test Report: ' + nice_name + '</p></td>
            <td  class="report_title" width=15%>&nbsp;</td>
          </tr>
        </tbody>
      </table>
    ...
    <table border=0 width=100% cellpadding=2 cellspacing=2>
      <tbody>
        <tr>
          <td class=report_title width=15%></td>
          <td class="report_title" width=10%>WAFT Component</td>
        ...
        <tr>
          <td class=report_title width=15%></td>
          <td class="report_title" width=10%>WAFT Test Run</td>
          <td class="report_title" width=2%>:</td>
